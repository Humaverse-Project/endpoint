...
use App\Repository\FichersCompetencesClientRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=FichersCompetencesClientRepository::class)
 */
class FichersCompetencesClient
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     ...
     * @ORM\JoinTable(name="fic_comp_competences_client")
     */
